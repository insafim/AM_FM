...
xlabel('Time/s');
ylabel('Amplitude/V');
title('Message Signal for Case(ii)')

subplot(2,1,2);
plot(t,md);
xlabel('Time/s');
ylabel('Amplitude/V');
title('Extracted Message Signal Case(ii) - Cutoff=2kHz')
...
xlabel('Time/s');
ylabel('Amplitude/V');
title('Extracted Message Signal for Case(ii) - Cutoff=0.1kHz')
...
xlabel('Time/s');
ylabel('Amplitude/V');
title('Extracted Message Signal for Case(ii) - Cutoff=10kHz')
